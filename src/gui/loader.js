...
dwvjq.gui.FileLoad = function (app)
{
    ...
    function onchangeinternal(event) {
        ...
        //console.log(files_img, files_json)

        app.loadFiles([files_img[0], file_json[0]]);
        //setTimeout(() => { app.loadFiles([files_json[0]]) }, 1000);
        //app.loadFiles(files_json[0]);
...
dwvjq.gui.FolderLoad = function (app)
{
    ...
    function onchangeinternal(event) {
        ...
        app.loadFiles([files_img[0], files_json[0]]);
        ...
        fileNext.onclick = function(){
            ...
            if (app.xcurrentSlice > app.xfiles.length){
                ...
                app.loadFiles([files_img[app.xcurrentSlice - 1], files_json[app.xcurrentSlice - 1]])
            }
        }
